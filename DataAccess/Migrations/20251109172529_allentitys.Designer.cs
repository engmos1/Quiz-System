...
namespace DataAccess.Migrations
{
    ...
    [Migration("20251109172529_allentitys")]
    partial class allentitys
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DataAccess.Models.CourseAssignment", b =>
                {
                    b.Property<int>("ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("DataAccess.Models.ExamQuestion", b =>
                {
                    b.Property<int>("ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("DataAccess.Models.StudentAnswer", b =>
                {
                    b.Property<int>("ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("DataAccess.Models.StudentExam", b =>
                {
                    b.Property<int>("ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("DataAccess.Models.CourseAssignment", b =>
                {
                    ...
                    b.HasOne("DataAccess.Identity.ApplicationUser", "Student")
                        .WithMany("CourseAssignments")
            ...
            modelBuilder.Entity("DataAccess.Models.Question", b =>
                {
                    b.HasOne("DataAccess.Identity.ApplicationUser", "CreatedByInstructor")
            ...
            modelBuilder.Entity("DataAccess.Models.StudentAnswer", b =>
                {
                    b.HasOne("DataAccess.Models.Choice", "Choice")
                        .WithMany()
                    ...
                    b.HasOne("DataAccess.Models.StudentExam", "StudentExam")
            ...
            modelBuilder.Entity("ExaminationSystem.Models.Course", b =>
                {
                    b.HasOne("DataAccess.Identity.ApplicationUser", "Instructor")
